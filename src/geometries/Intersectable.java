 ...
 */
	public static class GeoPoint {
	  ...
	  public static class Box {
	        ...
	        {
	        	double tmin = (x0 - r.getP0().get_x().get()) / r.getDir().getHead().get_x().get(); 
	        	double tmax = (x1 - r.getP0().get_x().get()) /r.getDir().getHead().get_x().get(); 
	    	    ...
	    	    double tymin = (y0 - r.getP0().get_y().get()) /r.getDir().getHead().get_y().get(); 
	        	double tymax = (y1 - r.getP0().get_y().get()) / r.getDir().getHead().get_y().get(); 
	    	    ...
	    	    double tzmin = (z0 - r.getP0().get_z().get()) / r.getDir().getHead().get_z().get(); 
	        	double tzmax = (z1 - r.getP0().get_z().get()) /r.getDir().getHead().get_z().get(); 
