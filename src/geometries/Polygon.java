...
public class Polygon extends Geometry {
    ...
    public Polygon(Color emm,Point3D... vertices) 
    {
    	this(new Material(0,0,0),emm,vertices);
    }
    public Polygon(Material material,Color emm,Point3D... vertices) 
    {
    	super(emm,material,null);
        ...
        Vector n = _plane.getNormal(new Point3D(1,1,1));
    ...
    public Vector getNormal(Point3D point) {
        return _plane.getNormal(new Point3D(point));
    }
    @Override
	public List<GeoPoint> findIntersections (Ray ray) {
		
		if(!IsIntersectionBox(ray))//the ray doesn't intersect the box
    	{
    		return null;
    	}
        ...
        if(si.get(0)>0) //check if all numbers are +
        {
