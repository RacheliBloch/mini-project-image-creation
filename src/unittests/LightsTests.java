...
public class LightsTests {
    ...
    /**
     * Produce a picture of a sphere lighted by all the kind of the light
     */
    @Test
    public void sphereLights() {
        ...
        scene.addLights(new SpotLight( new Vector(1, -1, 2),new Color(500, 300, 0),new Point3D(-50, 60, -50), 1, 0.001, 0.0001),
        		new PointLight(new Color(500, 300, 0), new Point3D(150, -200, -50), 1, 0.00001, 0.000001),
    ...
    /**
     * Produce a picture of a two triangles lighted by all the kind of the lights
     */
    @Test
    public void trianglesLights() 
    {
        ...
        scene.addLights(new SpotLight( new Vector(-2, 2, 1), new Color(500, 250, 250),new Point3D(50, 50, 130),1, 0.0001, 0.000005),
        		new PointLight(new Color(500, 250, 250),new Point3D(8, 3, 100),1, 0.000005, 0.0005),
        		new DirectionalLight(new Color(300, 150, 150), new Vector(0, 1, 1)));
