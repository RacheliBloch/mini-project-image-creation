...
public class ReflectionRefractionTests
{
	...
	public void twoSpheres() {
		...
		scene.addLights(new SpotLight(new Vector(-1, 1, 2),new Color(1000, 600, 0), new Point3D(-100, 100, -500),  1,
				0.0004, 0.0000006));
	...
	public void twoSpheresOnMirrors() {
		...
		scene.addLights(new SpotLight( new Vector(-1, 1, 4),new Color(1020, 400, 400),  new Point3D(-750, 750, 150), 
				   1, 0.00001, 0.000005));
